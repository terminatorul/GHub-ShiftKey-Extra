...
function mod:registerWith(buttonEventHandler, targetButton)
    buttonEventHandler.buttonDownEventTable:registerHandlerOverride(targetButton, self, self.onButtonPressed)
    buttonEventHandler.buttonUpEventTable:registerHandlerOverride(targetButton, self, self.onButtonReleased)
