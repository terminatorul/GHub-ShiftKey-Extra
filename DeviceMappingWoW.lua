...
local ShiftG10Action = DirectKeyMap:new(GHubDefs.ScanCodes.F2,  GHubDefs.ScanCodes.LeftShift, GHubDefs.ScanCodes.LeftAlt)
local ShiftG11Action = DirectKeyMap:new(GHubDefs.ScanCodes.F3,  GHubDefs.ScanCodes.LeftShift, GHubDefs.ScanCodes.LeftAlt)
...
local ShiftG16Action = DirectKeyMap:new(GHubDefs.ScanCodes.F8,  GHubDefs.ScanCodes.LeftShift, GHubDefs.ScanCodes.LeftAlt)
